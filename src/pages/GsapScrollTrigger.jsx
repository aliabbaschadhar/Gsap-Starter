...
import { ScrollTrigger } from "gsap/all"; //bexcause scroll trigger is a plugIn that allows you to create animations that are triggered by scroll positions of the page.
import { useRef } from "react";

gsap.registerPlugin(ScrollTrigger); //Registering the plugIn
			...
			boxes.map((box) => {
				gsap.to(box, {
					...
					scrollTrigger: {
						...
						scrub: true, //For smooth animation
					},
					ease: "power1.inOut",
				});
			});
